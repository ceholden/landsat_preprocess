...
Corner Lower Right Lat dec    Corner Lower Right Long dec
    ...
    \subsubsection{Extract IDs}\label{extract-ids}
...
{\color{incolor}In [{\color{incolor}16}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{bash}
         ...
         \PY{n}{wget} \PY{o}{\PYZhy{}}\PY{n}{nH} \PY{o}{\PYZhy{}}\PY{n}{nc} \PY{o}{\PYZhy{}}\PY{o}{\PYZhy{}}\PY{n}{cut}\PY{o}{\PYZhy{}}\PY{n}{dirs}\PY{o}{=}\PY{l+m+mi}{2} \PY{o}{\PYZhy{}}\PY{n}{r} \PY{o}{\PYZhy{}}\PY{n}{A} \PY{n}{L}\PY{o}{*}\PY{l+m+mi}{2014}\PY{o}{*}\PY{o}{\PYZhy{}}\PY{o}{*}\PY{n}{tar}\PY{o}{.}\PY{n}{gz}\PY{p}{,}\PY{n}{L}\PY{o}{*}\PY{l+m+mi}{2014}\PY{o}{*}\PY{o}{\PYZhy{}}\PY{o}{*}\PY{n}{cksum} \PY{o}{\PYZhy{}}\PY{n}{nv} \PY{err}{\PYZdl{}}\PY{n}{url}
...
common geographic
extent}\label{step-5.-combine-dataset-bands-into-stacked-images-of-common-geographic-extent}
...
drwxr-sr-x 3 ceholden landsat 32768 May  8 14:06 LE70200472014109ASN00
    ...
    \subsection{7. Create spatial subset using extent or polygon
ROI}\label{create-spatial-subset-using-extent-or-polygon-roi}
...
\paragraph{And if you really want to get
creative\ldots{}}\label{and-if-you-really-want-to-get-creative}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}219}]:} \PY{k+kn}{import} \PY{n+nn}{io}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}219}]:} <IPython.core.display.HTML at 0x1461cd0>
\end{Verbatim}
        
    \subsection{9. Summarize and document your
dataset}\label{summarize-and-document-your-dataset}
